        ...
        <nav class="navbar bg-light navbar-light">
            <a href="#"
               class="navbar-brand mx-4 mb-3">
                <h3 class="text-primary"><i class="fa fa-hashtag me-2"></i>ADHIVA'S</h3>
            </a>
            <div class="d-flex align-items-center ms-4 mb-4">
                ...
                <div class="ms-3">
                    <h6 class="mb-0">{{ session('user_name', 'Guest') }}</h6>
                    <span>{{ ucfirst(session('user_role', 'User')) }}</span>
                </div>
            </div>
                    ...
                    <a href="#"
                       ...
                       data-bs-toggle="dropdown">
                        <img class="rounded-circle me-lg-2"
                             ...
                             alt=""
                             style="width: 40px; height: 40px;">
                        <span class="d-none d-lg-inline-flex">{{ session('user_name', 'Guest') }}</span>
                    </a>
